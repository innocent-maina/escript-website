            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    <div class="inner-page-title">
                        ...
                        <h2 class="s-52 w-700">Engineering Tech Lead</h2>
                        <p class="p-lg">Vancouver, British Columbia, Canada / Remote</p>
                    </div>
                    <!-- TEXT BLOCK -->
                    <div class="txt-block role-info">
                        ...
                        <ul class="simple-list long-list">
                            ...
                            <li class="list-item">
                                <p>Quaerat sodales sapien euismod and purus blandit velna a vitae auctor congue magna tempor sapien ipsum gravida laoreet turpis urna augue, viverra a augue eget pulvinar</p>
                            </li>
                            <li class="list-item">
                                <p>Vitae auctor blandit velna congue magna and tempor sapien a turpis laoreet gravida</p>
                            </li>
                            <li class="list-item">
                                <p>Laoreet turpis urna augue, viverra a augue eget, dictum tempor diam pulvinar dictum tempor sagittis</p>
                            </li>
                            <li class="list-item">
                        ...
                        <ul class="simple-list long-list">
                            <li class="list-item">
                                <p>Sodales sapien quaerat euismod and purus blandit velna a vitae auctor congue magna tempor sapien ipsum gravida laoreet turpis urna augue, augue eget a viverra pulvinar laoreet augue luctus donec.</p>
                            </li>
                            <li class="list-item">
                                <p>Sodales sapien quaerat euismod and purus blandit velna a vitae auctor congue magna tempor sapien ipsum gravida laoreet turpis urna augue, augue eget a viverra pulvinar</p>
                            </li>
                            <li class="list-item">
                                <p>Blandit velna vitae auctor congue magna and tempor sapien a gravida laoreet turpis</p>
                            </li>
                            ...
                            <div class="row align-items-center row-cols-1 row-cols-md-2">
                                ...
                                <div class="col">
                                    <div id="cb-6-1" class="cbox-6">
                                        <!-- Title -->
                                        <h6 class="s-20 w-700">Flexible time off</h6>
                                        <!-- Text -->
                                        <p>Aliqum mullam blandit tempor sapien gravida donec ipsum, at porta justo velna vitae auctor congue magna nihil impedit ligula risus.</p>
                                    </div>
                                </div>
                                <!-- CONTENT BOX #2 -->
                                <div class="col">
                                    <div id="cb-6-2" class="cbox-6">
                                        <!-- Title -->
                                        <h6 class="s-20 w-700">Healthcare</h6>
                                        <!-- Text -->
                                        <p>Blandit tempor sapien aliqum mullam gravida donec ipsum, at porta justo velna vitae auctor congue mauris and donec magnis sapien</p>
                                    </div>
                                </div>
                                <!-- CONTENT BOX #3 -->
                                <div class="col">
                                    <div id="cb-6-3" class="cbox-6">
                                        <!-- Title -->
                                        <h6 class="s-20 w-700">The latest hardware</h6>
                                        <!-- Text -->
                                        <p>Mauris donec mullam blandit at tempor sapien gravida donec ipsum, at porta justo velna vitae auctor congue magna nihil impedit ligula</p>
                                    </div>
                                </div>
                                <!-- CONTENT BOX #4 -->
                                <div class="col">
                                    <div id="cb-6-4" class="cbox-6">
                                        <!-- Title -->
                                        <h6 class="s-20 w-700">Ergonomic equipment</h6>
                                        <!-- Text -->
                                        <p>Sapien gravida donec ipsum porta justo velna vitae auctor congue magna nihil impedit ligula risus. Mauris donec ociis sagittis tempor</p>
                                    </div>
                                </div>
                            </div>
                        </div>
