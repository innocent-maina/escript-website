<template>
    <section id="banner-13" class="pt-100 banner-section">
        <div class="container">
            <!-- BANNER-13 WRAPPER -->
            <div class="banner-13-wrapper bg--04 bg--fixed r-16 block-shadow">
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-7">
                            <div class="banner-13-txt">
                                <!-- Title -->
                                <h2 class="s-46 w-700">Getting started with Escript today!</h2>
                                <!-- Text -->
                                <p class="p-lg">Congue laoreet turpis neque auctor turpis vitae dolor a luctus placerat and magna ligula cursus</p>
                                <!-- Button -->
                                <a href="#" class="btn r-04 btn--theme hover--tra-black" data-bs-toggle="modal" data-bs-target="#modal-3">Get srarted - it's free</a>
                            </div>
                        </div>
                        <!-- END BANNER-13 TEXT -->
                        <!-- BANNER-13 IMAGE -->
