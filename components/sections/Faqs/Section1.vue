            ...
            <div class="row justify-content-center">
                <div class="col-lg-11 col-xl-10">
                    ...
                    <div class="accordion-wrapper">
                        <ul>
                            <ElementsAccordionItem title="Getting Started">
                                <!-- QUESTION #1 -->
                            ...
                            <ElementsAccordionItem title="Manage your account">
                                <!-- QUESTION #1 -->
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                            ...
                            <ElementsAccordionItem title="Purchase and License">
                                <!-- QUESTION #1 -->
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                            ...
                            <ElementsAccordionItem title="Policy, Safety & Copyright">
                                <!-- QUESTION #1 -->
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
                            ...
                            <ElementsAccordionItem title="Other Questions">
                                <!-- QUESTION #1 -->
                                <div class="accordion-panel-item mb-35">
                                    <!-- Question -->
                                    <div class="faqs-2-question">
