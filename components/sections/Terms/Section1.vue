            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    <div class="inner-page-title">
                        ...
                        <p class="p-lg">This policy is effective as of 23th October 2022</p>
                    </div>
                    <!-- TEXT BLOCK -->
                    <div class="txt-block legal-info">
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>1.</span> Ownership</h4>
                        <!-- Text -->
                        <p>Donec sodales nibh vel (the <span>&quot;Terms&quot;</span>) aliquet tristique purus justo suscipit mauris tempus sed laoreet nulla ante purus. Donec dolor and magna undo suscipit magna at tortor laoreet dignissim, undo porttitor massa quisque and mollis, sapien gravida aliquet ipsum ultrices aliquet lorem purus and vitae auris aliquam</p>
                        <!-- Text -->
                        <p>Sagittis congue augue egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque blandit fusce an aliquam nulla lacinia justo molestie blandit justo diam aliquet tortor molestie non sagittis lacinia</p>
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>2.</span> Acceptance of Terms</h4>
                        <!-- Text -->
                        ...
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>3.</span> Service Description</h4>
                        <!-- Text -->
                        ...
                        <ul class="simple-list">
                            <li class="list-item">
                                <p>Quaerat sodales sapien undo velna purus euismod purus velna blandit vitae auctor and congue magna tempor sapien gravida laoreet turpis urna augue, viverra a augue eget diam pulvinar</p>
                            </li>
                            <li class="list-item">
                        ...
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>4.</span> Account Information</h4>
                        <!-- Text -->
                        ...
                        <!-- Small Title -->
                        <h5 class="s-24 w-700"><span>4.1.</span> Registering for an account</h5>
                        <!-- Text -->
                        <p>Congue augue sagittis egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque blandit fusce lorem nulla an aliquam lacinia justo molestie blandit justo diam an aliquet tortor sagittis lacinia molestie diam egestas</p>
                        <!-- Text -->
                        ...
                        <!-- Small Title -->
                        <h5 class="s-24 w-700"><span>4.2.</span> Your responsibility for your account</h5>
                        <!-- Text -->
                        ...
                        <!-- Text -->
                        <p>Augue congue sagittis egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque donec and ipsum porta diam lorem sodales an aliquam lacinia justo sapien congue aliquet and sodales a quaerat tortor lacinia egestas</p>
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>6.</span> Method of Payment</h4>
                        <!-- Text -->
                        <p>Integer congue sagittis augue egestas velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque diam augue fusce sapien</p>
                        <!-- Text -->
                        <p>Sagittis augue congue egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec and augue luctus congue</p>
                        <!-- Small Title -->
                        <h5 class="s-24 w-700"><span>6.1.</span> Refunds</h5>
                        <!-- Text -->
                        <p>Integer congue sagittis augue egestas velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque diam augue fusce sapien nulla a primis lacinia ipsum a molestie blandit and justo an aliquet eget molestie sagittis at quaerat sodales</p>
                        <!-- Text -->
                        <p>Aliqum mullam tincidunt a sapien gravida and diam donec porta.</p>
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>7.</span> Security</h4>
                        <!-- Text -->
                        <p>Sagittis congue augue egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque blandit fusce lacinia placerat and nulla justo molestie blandit justo diam aliquet tortor molestie sagittis lacinia undo and mullam molestie diam luctus donec bibendum aliquet massa elementum. Libero quisque lacus and ligula massa lorem fusce cursus fusce nulla vitae massa placerat and mollis, sapien gravida aliquet ipsum ultrices aliquet lorem diam purus undo vitae aliquam auris dapibus libero fusce blandit.</p>
                        <!-- Title -->
                        <h4 class="s-30 w-700"><span>8.</span> Changes to This Terms of Service</h4>
                        <!-- Text -->
                        <p>Congue augue sagittis egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque blandit fusce lorem nulla an aliquam lacinia justo molestie blandit justo diam an aliquet tortor sagittis lacinia molestie diam egestas</p>
                        <!-- Text -->
                        <p>Sagittis augue congue egestas integer velna purus purus magna nec suscipit and egestas magna aliquam ipsum vitae purus justo lacus ligula ipsum primis cubilia donec undo augue luctus vitae egestas a molestie donec libero sapien dapibus congue tempor undo quisque fusce cursus neque aliquam fusce blandit</p>
