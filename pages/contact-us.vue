        ...
        <div class="row justify-content-center">
          <div class="col-md-10 col-lg-9">
            <div class="section-title text-center mb-80">
              ...
              <!-- Text -->
              <p class="p-lg">
                Want to learn more about Escript, get a quote, or speak with an
            ...
            <div class="form-holder">
              <form name="contactform" class="row contact-form">
                ...
                <div class="col-md-12">
                  ...
                  <span
                    >Your OS version, Escript version & build, steps you did. Be
                    VERY precise!</span
                  >
                  <textarea
                ...
                <div class="contact-form-notice">
                  <p class="p-sm">
                    We are committed to your privacy. Escript uses the
